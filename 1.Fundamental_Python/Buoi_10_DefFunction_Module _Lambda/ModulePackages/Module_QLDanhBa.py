...
#-----------------------------------------------------------------
def xuly_tracuu_danhba(traCuu,danhBa):
    ...
    return kq
#-----------------------------------------------------------------
def xuly_them_thongtin(ten,sdt,danhBa):
    if sdt in danhBa: 
...
#Nếu chạy gián tiếp, tức import vào chương trình khác để  chạy thì __name__ == __main__ sẽ là False, và câu lệnh dưới if không được thực thi
    ...
    while True:
        ...
        if choice == '1':
            ...
            kqthem = xuly_them_thongtin(ten,sdt,danhBa)
            print(kqthem)
